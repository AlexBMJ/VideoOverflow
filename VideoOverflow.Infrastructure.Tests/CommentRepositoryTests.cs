...
public class CommentRepositoryTests
{
    ...
    public async Task GetAll_Returns_All_Comments_With_Creator()
    {
        ...
        var user1Comment1 = new CommentCreateDTO()
            {CreatedBy = f.Entity.Id, Content = "This docker tutorial is smooth"};
        var user1Comment2 = new CommentCreateDTO()
            {CreatedBy = f.Entity.Id, Content = "Very helpful guide for beginners!"};
        ...
        Assert.Collection(comments,
            comment => Assert.Equal(new CommentDTO(1, 1, 0, "This docker tutorial is smooth"), comment),
    ...
    public async Task GetAll_Returns_All_Comments_Without_Creator()
    {
        ...
        Assert.Collection(comments,
            comment => Assert.Equal(new CommentDTO(1, 0, 0, "This docker tutorial is smooth"), comment),
    ...
    public async Task Push_Comment_On_Resource_Adds_Comment_To_Resource_By_Existing_User()
    {
        ...
        var expected = new Resource()
        {
            ...
            {
                new Comment()
                    {Id = 1, CreatedBy = 1, AttachedToResource = 1, Content = "I just commented on my own post :-)"}
            }
        };
