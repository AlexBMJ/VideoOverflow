...
public class UserRepositoryTests
{
    ...
    public async Task Update_Existing_User_Adds_Comments_and_changes_Name()
    {
        ...
        {
            Id = 1, Name = "Karl",
            Comments = new List<string>() {"I changed name from Deniz to Karl and added my first comment"}
        };
        ...
        var expected = new UserDTO(1, "Karl",
            new List<string>() {"I changed name from Deniz to Karl and added my first comment"});
